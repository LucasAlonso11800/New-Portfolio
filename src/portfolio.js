...
export const greetings = {
  ...
  description:
    "I'm a self-taught Full-Stack Developer whose main strengths are React, NodeJS and MySQL. I've been programming since 2020 and I keep working everyday to find the best solutions to the problems I encounter, to improve as a software developer and to keep growing on my professional career.",
...
export const experience = [
  {
    ...
    descBullets: [
      "Build web applications with React for different company areas like staff time control and accounting.",
      "Build microservices with Node and Golang, hosted in Google Cloud Platform.",
      "Write and maintain MySQL stored procedures.",
      "Build user interfaces for internal backoffice management with React.",
      "Work alongside designers to translate Adobe XD and Figma designs into responsive websites with React and Next JS.",
    ],
  },
  {
    company: "Freelancing",
